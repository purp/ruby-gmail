...
begin
  ...
  Jeweler::Tasks.new do |gem|
    gem.name = "purp-ruby-gmail"
    gem.summary = %Q{A Rubyesque interface to Gmail, with all the tools you'll need.}
    gem.description = %Q{A Rubyesque interface to Gmail, with all the tools you'll need. Search, read and send multipart emails; archive, mark as read/unread, delete emails; and manage labels. [This is a fork of http://github.com/justinperkins/ruby-gmail which is a fork of http://github.com/dcparker/ruby-gmail]}
    gem.email = "gems@behindlogic.com"
    gem.homepage = "http://github.com/purp/ruby-gmail"
